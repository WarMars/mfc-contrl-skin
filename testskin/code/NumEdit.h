...
protected:
	...
	void	Set_EditCtrl_Text(std::wstring strText);
	bool	Validate_Char(UINT nChar);
	double	Text_To_Number(const wchar_t* strText);
	std::wstring Number_To_Text(double fNumber);
